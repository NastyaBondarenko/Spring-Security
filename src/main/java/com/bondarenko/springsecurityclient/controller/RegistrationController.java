package com.bondarenko.springsecurityclient.controller;
...
import com.bondarenko.springsecurityclient.model.PasswordModel;
...
//    }
    ...
    public String resetPassword(@RequestBody PasswordModel passwordModel, HttpServletRequest request) {
        ...
        if (user != null) {
            ...
            userService.createPasswordResetTokenFroUser(user, token);
